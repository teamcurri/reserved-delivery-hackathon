...
import { Desktop as DesktopDocumentation } from './HeadingDocumentation'
...
const meta: Meta<typeof Desktop> = {
  ...
  parameters: {
    ...
    design: {
      type: 'figma',
      url: 'https://www.figma.com/file/bcmucq3rslzDXfTkPIsFqG/%E2%9D%96-Curri-UI-Library-v0.1?node-id=149%3A6522',
    },
    docs: {
